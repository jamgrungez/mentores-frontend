  ...
  return (
    <Modal.Root open={isOpen} onOpenChange={handleCloseModal}>
      <Modal.Content className="flex flex-col p-4 shadow-card max-w-[25rem]">
        ...
        <Modal.Title className="text-xl text-black-200 font-medium leading-6 text-center mb-4">
          Perfil removido
        </Modal.Title>
        <Modal.Description className="text-sm text-gray-700 leading-4 font-[Radio_Canada,sans-serif] mb-2">
